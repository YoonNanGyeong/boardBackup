                        ...
                        <body>
                            <form:form modelAttribute="searchVO" id="detailForm" name="detailForm" method="post">
                                ...
                                <div class="border">
                                    ...
                                    <header class="hd">
                                        <div class="prev-next">
                                            <input type="text" id="prevNextCondition" name="prevNextCondition" value=""
                                                style="display: none;" />
                                            <button class="prevNext-btn" id="prevNextBtn" name="prevNextBtn"
                                                type="button" value="prev">이전</button>
                                            <button class="prevNext-btn" id="prevNextBtn" name="prevNextBtn"
                                                type="button" value="next">다음</button>
                                        </div>
                                        <!-- list title -->
                                        <div class="title">
                                        ...
                                        <div class="user">
                                            ...
                                            <div id="ect">
                                                <p>
                                                    <c:out value="${boardVO.updateDt}" />&nbsp;
                                                </p>
                                                <p>조회</p>
                                                <p>
                                                    <c:out value="${boardVO.viewCnt}" />&nbsp;
                                                </p>
                                    ...
                                    <main class="mn">
                                            ...
                                            <div class="file-area">
                                                <c:forEach var="file" items="${fileList}" varStatus="status">
                                                    <c:if test="${fn:contains(file.fileType,'image')}">
                                                        <img src="<c:url value='/images/board/upload/${file.storeNm}'/>"
                                                            alt="image">
                                                    </c:if>
                                                </c:forEach>
                                            </div>
                                        ...
                                        <c:if test="${fileSize gt 0 && dateResult eq true}">
                                            ...
                                            <p style="color: #7CA3C6; font-size: 12px;">다운로드 아이콘을 클릭하면 첨부된 파일 전체를 압축파일로
                                                받을 수 있습니다.</p>
                                                    ...
                                                    <div class="files">
                                                        <a href="/fileDownload.do?storeNm=${file.storeNm}&uploadNm=${file.uploadNm}"
                                                            ...
                                                            <input type="hidden" id="storeNm" value="${file.storeNm}"
                                                                name="storeNm" />
                                                            <input type="text" id="uploadNm" value="${file.uploadNm}"
                                                                name="uploadNm" readonly="readonly" alt="첨부파일명 링크" />
                                                        </a>
                                                    </div>
                                                </c:forEach>
                                            </div>
