package egovframework.normal.board.zipUtil;
...
public class CompressZip {
	...
	public boolean compress(String path, String outputPath, String outputFileName)throws Throwable{
		...
		try {
			fos = new FileOutputStream(new File(outputPath + "\\" + outputFileName));	// images/board/upload/thm + '파일명.jpg'
